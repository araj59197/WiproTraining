...
![Wipro Training Banner](./assets/banner.png)
...
- ![pip](https://img.shields.io/badge/pip-Latest-3776AB?style=flat-square&logo=pypi&logoColor=white) **pip** (Python Package Manager)
...
|:-----------|:--------|:------|
| **Python** | Core Programming Language | ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) |
| **Selenium** | Web Browser Automation | ![Selenium](https://img.shields.io/badge/Selenium-43B02A?style=flat-square&logo=selenium&logoColor=white) |
| **Flask** | Web Framework | ![Flask](https://img.shields.io/badge/Flask-000000?style=flat-square&logo=flask&logoColor=white) |
| **BeautifulSoup** | Web Scraping | ![BeautifulSoup](https://img.shields.io/badge/BeautifulSoup-yellow?style=flat-square) |
| **Requests** | HTTP Client Library | ![Requests](https://img.shields.io/badge/Requests-2CA5E0?style=flat-square) |
| **JSON/XML** | Data Formats | ![JSON](https://img.shields.io/badge/JSON-000000?style=flat-square&logo=json&logoColor=white) |
| **Threading** | Concurrent Programming | ![Threading](https://img.shields.io/badge/Threading-orange?style=flat-square) |
...
```mermaid
graph LR
    A[🐍 Fundamentals] --> B[🔧 Functions & OOP]
    B --> C[⚡ Advanced OOP]
    C --> D[📂 Data Handling]
    D --> E[🌐 Web Frameworks]
    E --> F[🕷️ Web Scraping]
    ...
    style B fill:#43B02A,stroke:#fff,color:#fff
    style C fill:#F05032,stroke:#fff,color:#fff
    style D fill:#FF6B6B,stroke:#fff,color:#fff
    style E fill:#000000,stroke:#fff,color:#fff
    style F fill:#FFA500,stroke:#fff,color:#000
    style G fill:#43B02A,stroke:#fff,color:#fff
...
[![GitHub](https://img.shields.io/badge/GitHub-@araj59197-181717?style=for-the-badge&logo=github)](https://github.com/araj59197)
...
<img src="https://img.shields.io/github/stars/araj59197/WiproTraining?style=social" alt="GitHub stars">
